  ...
  return (
    <main className="background-container px-4">
      <div className="container all-content px-4">
        <div className="justify-content-center text-center home-container">
          ...
          <div className="px-2 py-1 textbox">
            <hr className="hrTag mb-2 mt-1 mx-auto" />
            <h5 className="home-desc px-0">
            ...
            <hr className="hrTag mb-1 mt-2 mx-auto" />
          </div>
        </div>
